...
<div id="panel_learn" class="x_panel">
    <modal v-if="showModal" @close="showModal = false;shown = false">
        ...
        <div slot="translate" v-show='shown'>@{{words[currentCategory][currentWord]['qrus']}}</div>
        <button slot="btnTranslate" class="btn btn-default" v-on:click="shown=!shown"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></button>
    </modal>
    <div class="col-sm-4">
        <ol>
    ...
    <div class="col-sm-8">
        <h3 v-if="currentCategory!=0">@{{categories[currentCategory - 1]['namerus']}}</h3>
